...
import arun.pkg.ocrintegration.BuildConfig
import arun.pkg.ocrintegration.databinding.MainFragmentBinding
import arun.pkg.ocrintegration.main.util.FileUriUtils
...
//                    viewModel.runTextExtraction(destPath)
    ...
    private fun getOutputMediaFile(): File? {
        ...
        val mediaStorageDir = activity?.externalCacheDir
